...
const SEED: Seed[] = [
  ...
  },
  {
    ...
    horas: 5569,
    desc: "Fresadora de 5 ejes con spindle y motor cambiados. Lista para trabajar desde el primer día.",
  ...
  },
  {
    ...
    cat: 4,
    precio: 4600,
    desc: "Impresora 3D DLP de alta precisión con fuente de luz UV 385 nm, compatible con una amplia gama de resinas dentales.",
    destacado: true,
    dias: 5,
  },
  {
    ...
    cat: 6,
    precio: 1800,
    desc: "Microscopio profesional con cámara digital integrada e iluminación LED de alta potencia.",
    dias: 7,
  },
  {
  ...
  },
  {
    ...
    cat: 7,
    precio: 900,
    desc: "Cabina de repasado y pulido con aspiración, iluminación LED y micromotor de alta calidad.",
    dias: 11,
  },
  {
  ...
  },
  {
    ...
    cat: 7,
    precio: 200,
    desc: "Caja de repaso con iluminación integrada y aspiración.",
    dias: 13,
  },
  {
